...
*
   ...
   * @project_name : Heshan-Md

   * @author : Heshan <https://github.com/Heshanmd2007/HESHAN-MD-V1>

   * @youtube : https://www.youtube.com/c/@SuhailTechInfo

   * @infoription : heshan-Md ,A Multi-functional whatsapp user bot.
...
* 
   ...
   * ┌┤Created By Heshan md Info.

   * © 2025 Heshan-Md ✭ ⛥.

   * plugin date : 12/04/2025
